  ...
  static addToolbarButton(moduleId) {
    Hooks.on("getSceneControlButtons", (controls) => {
      ...
      tokenControls.tools["midi-qol-upload"] = {
        ...
        button: true,
        onChange: () => {
          console.log("midi-qol-upload | onChange fired");
          ...
          const content = `
            <div class="stats-uploader-dialog">
              <p>This will upload a <strong>snapshot</strong> of current midi-qol session
              stats for all actors to your database.</p>
